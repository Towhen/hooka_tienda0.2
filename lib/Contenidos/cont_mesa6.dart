...
class InterioMesa6 extends StatelessWidget {
  @override
...
class _EmptyTable6 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable6 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable6 extends StatefulWidget {
  @override
  _ShoppingTable6 createState() => _ShoppingTable6();
}

class _ShoppingTable6 extends State<ShoppingTable6> {
...
class ShoppingTable6_2 extends StatelessWidget {
  const ShoppingTable6_2({Key key, this.product}) : super(key: key);
