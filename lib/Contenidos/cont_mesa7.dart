...
class InterioMesa7 extends StatelessWidget {
  @override
...
class _EmptyTable7 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable7 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable7 extends StatefulWidget {
  @override
  _ShoppingTable7 createState() => _ShoppingTable7();
}

class _ShoppingTable7 extends State<ShoppingTable7> {
...
class ShoppingTable7_2 extends StatelessWidget {
  const ShoppingTable7_2({Key key, this.product}) : super(key: key);
