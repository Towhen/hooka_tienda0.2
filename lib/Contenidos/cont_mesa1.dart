...
class InterioMesa1 extends StatelessWidget {
  @override
...
class _EmptyTable1 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable1 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable1 extends StatefulWidget {
  @override
  _ShoppingTable1 createState() => _ShoppingTable1();
}

class _ShoppingTable1 extends State<ShoppingTable1> {
...
class ShoppingTable1_2 extends StatelessWidget {
  const ShoppingTable1_2({Key key, this.product}) : super(key: key);
