...
class InterioMesa10 extends StatelessWidget {
  @override
...
class _EmptyTable10 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable10 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable10 extends StatefulWidget {
  @override
  _ShoppingTable10 createState() => _ShoppingTable10();
}

class _ShoppingTable10 extends State<ShoppingTable10> {
...
class ShoppingTable10_2 extends StatelessWidget {
  const ShoppingTable10_2({Key key, this.product}) : super(key: key);
