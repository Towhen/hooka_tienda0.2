...
class InterioMesa3 extends StatelessWidget {
  @override
...
class _EmptyTable3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable3 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable3 extends StatefulWidget {
  @override
  _ShoppingTable3 createState() => _ShoppingTable3();
}

class _ShoppingTable3 extends State<ShoppingTable3> {
...
class ShoppingTable3_2 extends StatelessWidget {
  const ShoppingTable3_2({Key key, this.product}) : super(key: key);
