...
class InterioMesa5 extends StatelessWidget {
  @override
...
class _EmptyTable5 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable5 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable5 extends StatefulWidget {
  @override
  _ShoppingTable5 createState() => _ShoppingTable5();
}

class _ShoppingTable5 extends State<ShoppingTable5> {
...
class ShoppingTable5_2 extends StatelessWidget {
  const ShoppingTable5_2({Key key, this.product}) : super(key: key);
