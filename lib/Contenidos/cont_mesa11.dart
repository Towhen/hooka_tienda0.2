...
class InterioMesa11 extends StatelessWidget {
  @override
...
class _EmptyTable11 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable11 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable11 extends StatefulWidget {
  @override
  _ShoppingTable11 createState() => _ShoppingTable11();
}

class _ShoppingTable11 extends State<ShoppingTable11> {
...
class ShoppingTable11_2 extends StatelessWidget {
  const ShoppingTable11_2({Key key, this.product}) : super(key: key);
