...
class InterioMesa4 extends StatelessWidget {
  @override
...
class _EmptyTable4 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable4 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable4 extends StatefulWidget {
  @override
  _ShoppingTable4 createState() => _ShoppingTable4();
}

class _ShoppingTable4 extends State<ShoppingTable4> {
...
class ShoppingTable4_2 extends StatelessWidget {
  const ShoppingTable4_2({Key key, this.product}) : super(key: key);
