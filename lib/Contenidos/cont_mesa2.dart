...
class InterioMesa2 extends StatelessWidget {
  @override
...
class _EmptyTable2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable2 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable2 extends StatefulWidget {
  @override
  _ShoppingTable2 createState() => _ShoppingTable2();
}

class _ShoppingTable2 extends State<ShoppingTable2> {
...
class ShoppingTable2_2 extends StatelessWidget {
  const ShoppingTable2_2({Key key, this.product}) : super(key: key);
