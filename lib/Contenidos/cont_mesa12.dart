...
class InterioMesa12 extends StatelessWidget {
  @override
...
class _EmptyTable12 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable12 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable12 extends StatefulWidget {
  @override
  _ShoppingTable12 createState() => _ShoppingTable12();
}

class _ShoppingTable12 extends State<ShoppingTable12> {
...
class ShoppingTable12_2 extends StatelessWidget {
  const ShoppingTable12_2({Key key, this.product}) : super(key: key);
