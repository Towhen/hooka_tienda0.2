...
class InterioMesa9 extends StatelessWidget {
  @override
...
class _EmptyTable9 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Column(
...
class _FullTable9 extends StatelessWidget {
  var i = 0xff3a3e3e3e;
  @override
  Widget build(BuildContext context) {
    return Flexible(
...
class ShoppingTable9 extends StatefulWidget {
  @override
  _ShoppingTable9 createState() => _ShoppingTable9();
}

class _ShoppingTable9 extends State<ShoppingTable9> {
...
class ShoppingTable9_2 extends StatelessWidget {
  const ShoppingTable9_2({Key key, this.product}) : super(key: key);
